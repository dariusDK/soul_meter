...
class SpotifyApiButtonWidget extends StatefulWidget {
  String title;

  SpotifyApiButtonWidget(String title) {
    this.title = title;
  }

  @override
  _SpotifyApiButtonWidgetState createState() => _SpotifyApiButtonWidgetState();
}

class _SpotifyApiButtonWidgetState extends State<SpotifyApiButtonWidget> {
